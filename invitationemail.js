const dynamicMail = (fullName, code) => {
    return `
                    ...
                    <tr>
                        <td>
                            <div style="padding: 0 2.5em; text-align: center;">
                                ...
                                <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Welcome On Board , ${fullName}.<br/>Kindly c your OTP.</h3>
                                <p><a href="" class="btn btn-primary" style="padding: 15px 35px; display: inline-block; border-radius: 
                                3px; background: #7e2e00; color: #ffffff; text-decoration: none;">${code}</a></p>
